...
<a href="javascript:frm_delete_field_option(<?php echo $field['id']?>,<?php echo $opt_key ?>);" class="frm_single_visible_hover"><img src="<?php echo FRM_URL ?>/images/trash.png" alt="<?php _e('Delete') ?>" style="vertical-align:middle;" /></a>
