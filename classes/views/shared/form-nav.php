...
<li> <a<?php if($current_page == 'frm_display' or $pagenow == 'post.php' or $pagenow == 'post-new.php' or $current_page == 'formidable-entry-templates') echo ' class="current_page"'; ?> href="<?php echo esc_url($frm_vars['pro_is_installed'] ? admin_url('edit.php?post_type=frm_display') . "&form=$id&show_nav=1" : admin_url( 'admin.php?page=formidable-entry-templates')); ?>"><?php _e('Views', 'formidable') ?></a></li>
