...
<li> <a<?php if($current_page == 'frm_display' or $pagenow == 'post.php' or $pagenow == 'post-new.php') echo ' class="current_page"'; ?> href="<?php echo esc_url(admin_url('edit.php?post_type=frm_display') . "&form=$id&show_nav=1") ?>"><?php _e('Views', 'formidable') ?></a></li>
