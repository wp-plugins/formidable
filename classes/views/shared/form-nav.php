...
<ul class="frm_form_nav">
	 <li class="last"> <a<?php if($current_page == 'formidable-reports') echo ' class="current_page"'; ?> href="<?php echo admin_url('admin.php?page=formidable') ?>-reports&amp;frm_action=show&amp;form=<?php echo $id ?>&amp;show_nav=1"><?php _e('Reports', 'formidable') ?></a></li>
