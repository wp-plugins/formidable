...
<div id="taxonomy-linkcategory" class="categorydiv">
    <ul id="category-tabs" class="category-tabs frm-category-tabs">
		...
		<li class="hide-if-no-js"><a href="#frm-html-tags"><?php _e( 'HTML Tags', 'formidable' ); ?></a></li>
	</ul>
	...
	<div id="frm-html-tags" class="tabs-panel" style="display:none;max-height:none;padding-right:0;">
	    <p class="howto"><?php _e('Fields', 'formidable') ?></p>
    	...
    	<li class="frm_col_<?php echo $col ?>">
    	    <a class="frmbutton button <?php echo is_array($sname) ? 'frm_help' : ''; ?>" onclick="frmInsertFieldCode(jQuery(this),'<?php echo $skey ?>');return false;" href="#" <?php echo is_array($sname) ? 'title="'. $sname['title'] .'"' : ''; ?>><?php echo is_array($sname) ? $sname['label'] : $sname; ?></a>
    	</li>
        <?php
            $col = ($col == 'one') ? 'two' : 'one';
            unset($skey);
        ...
        <p class="clear howto"><?php _e('Before & After Fields', 'formidable') ?></p>
        ...
        <ul class="frm_code_list">
            ...
            <li class="frm_col_<?php echo $col ?>">
        	    <a class="frmbutton button" onclick="frmInsertFieldCode(jQuery(this),'<?php echo $skey ?>');return false;" href="#"><?php echo $sname; ?></a>
        	</li>
            <?php
                $col = ($col == 'one') ? 'two' : 'one'; 
            } ?>
