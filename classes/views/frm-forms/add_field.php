...
<li id="frm_field_id_<?php echo $field['id']; ?>" class="form-field edit_form_item frm_field_box ui-state-default frm_hide_options<?php echo $display['options'] ?> edit_field_type_<?php echo $display['type'] ?> frm_top_container" onmouseover="frm_field_hover(1,<?php echo $field['id']; ?>)" onmouseout="frm_field_hover(0,<?php echo $field['id']; ?>)">
    <a href="javascript:void(0);" class="alignright frm-show-hover frm-move frm-hover-icon" title="<?php esc_attr_e('Move Field', 'formidable') ?>"><img src="<?php echo FrmAppHelper::plugin_url() ?>/images/move.png" alt="<?php esc_attr_e('Move') ?>" /></a>
    <a href="javascript:frm_delete_field(<?php echo $field['id']; ?>)" class="alignright frm-show-hover frm-hover-icon" id="frm_delete_field<?php echo $field['id']; ?>" title="<?php esc_attr_e('Delete Field', 'formidable') ?>"><img src="<?php echo FrmAppHelper::plugin_url() ?>/images/trash.png" alt="<?php esc_attr_e('Delete') ?>" /></a>
    <a href="javascript:frm_duplicate_field(<?php echo $field['id']; ?>)" class="alignright frm-show-hover frm-hover-icon" title="<?php esc_attr_e('Duplicate Field', 'formidable') ?>"><img src="<?php echo FrmAppHelper::plugin_url() ?>/images/duplicate.png" alt="<?php _e('Duplicate', 'formidable') ?>" /></a>
