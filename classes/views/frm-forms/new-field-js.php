...
url:ajaxurl,params:"action=frm_field_option_ipe", default_text:"<?php _e('(Blank)', 'formidable') ?>"
});
...
url:ajaxurl,params:"action=frm_field_desc_in_place_edit",field_type:'textarea',textarea_rows:3,
