...
?>
<script type="text/javascript">jQuery(document).ready(function($){ var frm_pos=jQuery('#frm_form_<?php echo $form->id ?>_container').offset();var cOff=document.documentElement.scrollTop || document.body.scrollTop;if(frm_pos) window.scrollTo(frm_pos.left,frm_pos.top);})</script><?php        
    }else{
