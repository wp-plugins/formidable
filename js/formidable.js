function frmFrontFormJS(){
	...
	function checkDependentField(selected, field_id, rec, parentField){
            ...
            if ( getRepeat === true ) {
                ...
                if ( repeat.length ) {
                    repeat.each(function(){
                        hideOrShowField(i, f, field_id, selected, rec, jQuery(this));
                    });
                    return;
                }
            }
			...
			success:function(html){
                ...
                jQuery(html).find('input, select, textarea').each(function(){
                    ...
                    if ( jQuery.inArray(fieldID, checked ) == -1 ) {
                        ...
                        checkDependentField('und', fieldID, null, jQuery(this));
                    }
                });
