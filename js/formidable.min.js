...
d){"checkbox"==a.DataType?jQuery("#field_"+a.HideField+"-"+d).attr("checked","checked"):"select"==a.DataType?jQuery("select[name='item_meta["+a.HideField+"]"+f+"']").val(d):jQuery("input[name='item_meta["+a.HideField+"]']").val(d)});frmCheckDependent("",a.HideField)}})}
