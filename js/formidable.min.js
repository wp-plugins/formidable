...
var f=document.documentElement.scrollTop||document.body.scrollTop;e&&(0<e&&f>e)&&jQuery(window).scrollTop(e);if("function"==typeof frmThemeOverride_frmAfterSubmit){if(d=jQuery(b).find('input[name="form_id"]').val())var j=jQuery('input[name="frm_page_order_'+d+'"]').val();frmThemeOverride_frmAfterSubmit(d,j,b)}0<jQuery(a).find('input[name="id"]').length&&(b=jQuery(a).find('input[name="id"]').val(),jQuery("#frm_edit_"+b).find("a").addClass("frm_ajax_edited").click())}else{jQuery(a).find('input[type="submit"]').removeAttr("disabled");
...
function frmCancelEdit(a,d,b,h,e,f,j){var l=jQuery("#frm_edit_"+a).text();jQuery("#frm_edit_"+a).find("a").hasClass("frm_ajax_edited")||(jQuery("#"+d+a).children(".frm_forms").replaceWith(""),jQuery("#"+d+a).children(".frm_orig_content").fadeIn("slow").removeClass("frm_orig_content"));jQuery("#frm_edit_"+a).replaceWith('<a id="frm_edit_'+a+'" class="frm_edit_link '+j+'" href="javascript:frmEditEntry('+a+",'"+h+"','"+d+"',"+e+","+f+",'"+l+"','"+j+"')\">"+b+"</a>")}
