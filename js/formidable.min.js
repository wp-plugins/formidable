jQuery(document).ready(function(a){a(".frm_ajax_loading").css("visibility","hidden");var c=a(".frm_blank_field").closest(".frm_toggle_container").prev(".frm_trigger");c&&frmToggleSection(c);if(a.isFunction(a.fn.on))a(document).on("click",'.frm-show-form input[type="submit"]',function(){frmSetNextPage(a(this))});else a('.frm-show-form input[type="submit"]').live("click",function(){frmSetNextPage(a(this))})});
function frmSetNextPage(a){var c=a.parents("form:first");"frm_prev_page"==a.attr("name")?(a=jQuery(c).find(".frm_next_page").attr("id").replace("frm_next_p_",""),c=""):"frm_save_draft"==a.attr("name")?(a="",c=1):c=a="";jQuery(".frm_next_page").val(a);jQuery(".frm_saving_draft").val(c)}
